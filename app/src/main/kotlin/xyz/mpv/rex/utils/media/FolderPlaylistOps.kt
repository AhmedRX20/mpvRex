  ...
  suspend fun generateFolderPlaylist(
    ...
    runCatching {
      ...
      val files = parentFolder.listFiles { file ->
        file.isFile &&
          FileTypeUtils.isMediaFile(file) &&
      ...
      val siblingFiles = if (lSource == "video_list" || lSource == "recently_played_button" || lSource == "first_video_button") {
        ...
        val videosInFolder = MediaFileRepository.getVideosForBuckets(context, setOf(bucketId))
        ...
        val videosInFolder = VideoScanUtils.getVideosInFolder(context, parentFolder.absolutePath)
